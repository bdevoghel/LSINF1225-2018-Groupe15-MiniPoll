...
public class ExpandableListAdapterresultat extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapterresultat(Context context, List<String> listDataHeader, List<String> ListDataHeaderdescription,
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        else if(resultatquizz.good.get(groupPosition).toString().compareTo(childText) == 0)
        {
            convertView.setBackgroundColor(_context.getResources().getColor(android.R.color.holo_green_dark));
        }
        else
