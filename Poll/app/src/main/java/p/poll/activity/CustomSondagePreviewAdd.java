...
public class CustomSondagePreviewAdd extends ArrayAdapter<String>{
    private final Activity context;
    private final String[] web;
    public CustomSondagePreviewAdd(Activity context,
                                  String[] web) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        txtDescription.setText(Sondageprevue.listedescriptionliste[position]);
