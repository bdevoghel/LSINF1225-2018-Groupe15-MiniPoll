...
CREATE TABLE Poll (username_proprietaire TEXT NOT NULL ,idpoll INTEGER NOT NULL PRIMARY KEY,titre TEXT NOT NULL,description TEXT NOT NULL,types TEXT NOT NULL,status_principal INTEGER);
