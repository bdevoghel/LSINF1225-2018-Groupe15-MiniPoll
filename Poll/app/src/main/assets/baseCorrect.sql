...
CREATE TABLE Questionnaire_and_Advice_Answer (username TEXT NOT NULL PRIMARY KEY,idquestion TEXT NOT NULL,reponse_utilisateur TEXT);
CREATE TABLE Survey (idpoll TEXT NOT NULL,data_reponse TEXT NOT NULL);
CREATE TABLE Survey_Answer (idpoll TEXT NOT NULL PRIMARY KEY,username TEXT NOT NULL ,reponse TEXT NOT NULL,ordre INTEGER NOT NULL);
CREATE TABLE Poll_access (idpoll TEXT NOT NULL PRIMARY KEY,username TEXT NOT NULL,statut_particulier FLOAT);
...
INSERT INTO reponse_Survey VALUES('P4','donadede','C',4);
